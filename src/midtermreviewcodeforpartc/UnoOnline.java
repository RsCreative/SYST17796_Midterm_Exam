...
public class UnoOnline {
    ...
    /**
     * method that takes in the User's name and chosen password and then continues
     * prompting until the password is valid based on the following two rules: 1.
     * The password must be at least length 8 2. The password must contain at least
    ...
    private void run() {
        ...
        UserNameValidator us = new UserNameValidator();
        us.nameCheck();
